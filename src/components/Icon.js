...
export const Icon = (props) => {
  switch (props.iconName) {
    case 'work':
      return <WorkIcon color='hsl(15, 100%, 70%)' />;
    case 'play':
      return <PlayIcon color='hsl(195, 74%, 62%)' />;
    case 'study':
      return <StudyIcon color='hsl(348, 100%, 68%)' />;
    case 'exercise':
      return <ExerciseIcon color='hsl(145, 58%, 55%)' />;
    case 'social':
      return <SocialIcon color='hsl(264, 64%, 52%)' />;
    case 'self care':
      return <SelfCare color='hsl(43, 84%, 65%)' />;
    default:
      return;
  }
};
...
const WorkIcon = (props) => {
  return (
    <div
      className={classes['card__photo-container']}
